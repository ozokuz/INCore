package ozokuz.incore.features.market.command;
...
import ozokuz.incore.features.market.MarketItemDefinition;
...
public final class MarketCommands {
    ...
    private static int sync(CommandContext<CommandSourceStack> context) {
        ...
        for (ServerPlayer target : targets) {
            MarketNetworking.openMarketScreen(target, MarketService.buildScreenData(target, target.getServer(), false, null));
            synced++;
        }
