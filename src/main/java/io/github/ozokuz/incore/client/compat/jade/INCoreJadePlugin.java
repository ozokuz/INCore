...
import io.github.ozokuz.incore.features.research.station.AbstractResearchControllerBlock;
...
public class INCoreJadePlugin implements IWailaPlugin {
    ...
    private static class ResearchOrchestratorProvider implements IBlockComponentProvider, IServerDataProvider<BlockAccessor> {
        ...
        public void appendServerData(CompoundTag data, BlockAccessor accessor) {
            ...
            var networkSnapshot = io.github.ozokuz.incore.features.research.station.network.StationNetworkService.snapshot(accessor.getLevel().getServer(), orchestrator.teamId());
