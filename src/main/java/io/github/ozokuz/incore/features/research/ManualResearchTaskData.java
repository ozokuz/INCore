...
public record ManualResearchTaskData(ResourceLocation id, String title, String description, ResourceLocation itemId, int itemCount, boolean repeatable) {
    public static ManualResearchTaskData fromJson(ResourceLocation id, JsonObject json) {
        ...
        return new ManualResearchTaskData(id, title, description, itemId, itemCount, repeatable);
    }
}
