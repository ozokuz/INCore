...
public class MarketTerminalCardMenu extends AbstractContainerMenu {
    ...
    public MarketTerminalCardMenu(int containerId, Inventory playerInventory, MarketTerminalBlockEntity blockEntity) {
        super(Registration.MARKET_TERMINAL_CARD_MENU.get(), containerId);
        this.blockEntity = blockEntity;

        addSlot(new Slot(blockEntity, MarketTerminalBlockEntity.CARD_SLOT, CARD_X, CARD_Y) {
            @Override
            public boolean mayPlace(ItemStack stack) {
                return blockEntity.canPlaceItem(MarketTerminalBlockEntity.CARD_SLOT, stack);
            }
    ...
    public ItemStack quickMoveStack(Player player, int index) {
        ...
        int machineSlots = MarketTerminalBlockEntity.SLOT_COUNT;
